...
<div  id='write'  class = 'is-mac'><h1><a name="pythonbbs" class="md-header-anchor"></a><span>PythonBBS</span></h1><p><span>使用Python3.6+Flask搭建一个简单的BBS.</span></p><p><span>前台页面Flask，使用sqlalchemy完成orm数据库表和类别的映射。数据库使用Mysql 5.7.22版本。</span></p><p><span>实现个人用户注册、登陆、留言，主题和类别新增。</span>
<span>要求：</span>
<span>1.常规密码验证</span>
